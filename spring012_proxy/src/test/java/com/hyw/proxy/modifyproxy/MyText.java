...
import com.hyw.mytest.modifyproxy.util.InvocationUtil;
import com.hyw.mytest.modifyproxy.util.TimeInvocation4;
...
public class MyText {
    ...
    public void test03(){
        UserInterface target = new UserImpl();
        UserInterface userProxy = (UserInterface) InvocationUtil.getTimeInvocation(target);
        userProxy.createUser();
        userProxy.useUser();
        userProxy.destroyUser();
    }
    ...
    public void test04(){
        ...
        UserInterface proxy = (UserInterface) TimeInvocation4.getProxy(user);
        proxy.createUser();
        proxy.useUser();
        proxy.destroyUser();
    }
